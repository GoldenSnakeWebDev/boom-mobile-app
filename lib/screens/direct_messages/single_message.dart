...
class _SingleMessageState extends State<SingleMessage> {
  ...
  late DMCrontroller controller;

  final _storage = GetStorage();
  @override
  void initState() {
    super.initState();
    controller = Get.put(DMCrontroller());
  }
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return ListTile(
                                    ...
                                    trailing: widget.boomBoxModel.members[index]
                                                .user.userId ==
                                            controller.userId
                                        ? const SizedBox()
                                        : widget.boomBoxModel.members[index]
          ...
          child: Column(
            children: [
              Expanded(
                child: StreamBuilder(
                  stream:
                      controller.service.fetchMessages(widget.boomBoxModel.id),
                      ...
                      if (snapshot.hasError) {
                        ...
                        WidgetsBinding.instance.addPostFrameCallback((_) {
                          if (controller.listViewController.hasClients) {
                            controller.listViewController.jumpTo(controller
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: Obx(
                    () => (controller.isLoading.value)
                        ...
                        : IconButton(
                            onPressed: () async {
                              controller.chatWithUser(_messageController.text,
