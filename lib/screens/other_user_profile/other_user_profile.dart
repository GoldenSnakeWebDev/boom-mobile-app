                                                                      ...
                                                                      showDialog(
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return AlertDialog(
                                                                            ...
                                                                            content:
                                                                                Text("Are you sure you want to block !${user.user!.username}?"),
                                                                            actions: [
                                                                              TextButton(
                                                                                onPressed: () {
                                                                      ...
                                                                      showDialog(
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return AlertDialog(
                                                                            ...
                                                                            content:
                                                                                Text("Are you sure you want to report !${user.user!.username}?"),
                                                                            actions: [
                                                                              TextButton(
                                                                                onPressed: () {
                                                                                  Navigator.pop(context);
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (!fans
                                                                          .contains(
                                                                              myUserId)) {
                                                                        await otherProfileService.followUser(user
                                                                            .user!
                                                                            .id!);
                                                                      } else {
                                                                        await otherProfileService.unFollowUser(user
                                                                            .user!
                                                                            .id!);
                                                                      }
                                                                    },
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap: () {
                                                                      ...
                                                                      showModalBottomSheet(
                                                                          ...
                                                                          builder: (context) {
                                                                            return GetBuilder<OtherUserProfileController>(builder:
                                                                                (controller) {
                                                                              return Container(
